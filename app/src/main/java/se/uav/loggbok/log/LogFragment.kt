 ...
 * [LogFragment.OnListFragmentInteractionListener] interface.
 */
class LogFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                val trips = if (tripViewModel.trips.value != null) tripViewModel.trips.value!! else listOf()
    ...
    interface OnListFragmentInteractionListener {
        fun onTripInteraction(trip: Trip?)
    }
